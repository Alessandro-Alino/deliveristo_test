...
class ImageListSubBreedsDropDownSelect extends StatelessWidget {
  const ImageListSubBreedsDropDownSelect({super.key});
              ...
              child: Center(child: BlocBuilder<BreedsBloc, BreedsState>(
                builder: (context, state) {
                  if (state is BreedsInitialState) {
                    ...
                    return BlocBuilder<SelectedSubBreedForListSubBreed,
                        String?>(
                            ...
                            child: DropdownButton(
                              ...
                              items: getDropdownMenuItems(state.listBreeds
                                  .where((element) =>
                                      element.breedName ==
                                      context
                                          .watch<SelectedBreedForListSubBreed>()
                                          .state)
                                  .toList()),
                              isExpanded: true,
                              ...
                              onChanged: (value) {
                                context
                                    .read<SelectedSubBreedForListSubBreed>()
                                    .selectSubBreedForListSubBreed(value);
                              },
                            ),
                          ),
                        );
