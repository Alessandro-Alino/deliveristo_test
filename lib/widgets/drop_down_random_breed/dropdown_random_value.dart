...
class DropDownRandomBreed extends StatelessWidget {
  const DropDownRandomBreed({super.key, required this.breedsList});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SelectedBreed, String?>(
      builder: (context, state) {
        return Theme(
          ...
          child: DropdownButton(
            key: const Key('downloadedBreedList'),
            ...
            value: context.read<SelectedBreed>().state,
            onChanged: (value) {
              context.read<SelectedBreed>().selectBreedRandomImage(value);
            },
          ),
        );
      },
